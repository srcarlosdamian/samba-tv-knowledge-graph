...
export const audienceData = {
  ...
  alsoInterestedIn: [
    ...
    { name: 'Biography',        index: '2.6×', count: '7.1k',  type: 'topic', pct: 0.65 },
    { name: 'Science',          index: '2.6×', count: '30.1k', type: 'genre', pct: 0.65 },
    { name: 'Sports Analysis',  index: '2.1×', count: '25.8k', type: 'genre', pct: 0.52 },
    { name: 'True Crime',       index: '2.1×', count: '5.4k',  type: 'topic', pct: 0.52 },
    { name: 'News',             index: '2.0×', count: '5.4k',  type: 'genre', pct: 0.50 },
  ...
  // Age bands — people per band, summed (matches bar heights in screenshot)
  ageBands: [15, 38, 75, 68, 52, 62, 72, 36, 18],
  ageBandLabels: ['18-20', '21-24', '25-34', '35-44', '45-49', '50-54', '55-64', '65-71', '75+'],
  // Household income — 11 bands, skews mid-market
  incomes: [12, 20, 30, 38, 48, 75, 60, 38, 22, 16, 8],
  incomeLabels: ['0-25k', '25-35k', '35-50k', '40-75k', '40-75k', '75-100k', '100-125k', '125-150k', '150-175k', '175-200k', '200k+'],
  race: [
